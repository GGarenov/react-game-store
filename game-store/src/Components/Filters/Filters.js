  ...
  return (
    <div className={styles.filters}>
      ...
      <div className={styles.globalFilters}>
        <div className={styles.filterDiv}>
          <button className={styles.filterBtn}>
            <Wishlist className={styles.filterSVG1} />
          </button>
          Wishlist
        </div>
        ...
        <div className={styles.filterDiv}>
          <button className={styles.filterBtn2}>
            <Ratings className={styles.filterSVG2} />
          </button>
          Ratings
        </div>
        ...
        <div className={styles.filterDiv}>
          <button className={styles.filterBtn3}>
            <Reviews className={styles.filterSVG3} viewBox="0 0 48 48" style={{ fill: "#fff" }} />
          </button>
          Reviews
        </div>
      </div>
      ...
      <div className={styles.genreFilters}>
        ...
        <div className={styles.filterDiv}>
          <button className={styles.filterBtn3}>
            <Action className={styles.filterSVG3} />
          </button>
          Action
        </div>
